...
import pt.isel_leic_g09.kmp_mapbox.configs.DrawingButtonsConfig
import pt.isel_leic_g09.kmp_mapbox.configs.FollowButtonConfig
...
private fun BoxScope.DrawingButtons(
    ...
    Column(
        ...
        FloatingActionButton(
            ...
            Icon(
                imageVector = config.cancelButtonImage,
